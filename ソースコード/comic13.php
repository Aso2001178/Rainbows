    ...
    <div id="parent">
        <div id="child1">
            ...
            <div class="btn">
                ...
                <a href="withdraw.php" class="button">退会</a><br>
                <a href="toppage.php" class="button">トップページ</a>
            </div>
        </div>
        <div id="child2">
            <div class="comicimg"><img src="img/カイジ.png" width="260" height="386"></div><br>
            <?php
            $pdo = new PDO('mysql:host=mysql147.phy.lolipop.lan;
                dbname=LAA1291127-rainbows;charset=utf8',
                'LAA1291127',
                '1234123');
            foreach($pdo->query('SELECT item_code, item_name, price FROM m_items WHERE item_code = 13') as $row){
            ...
            <div class="comic_summary">
                上京後、自堕落な日々を過ごしていた伊藤開司（カイジ）は、<br>
                ある日金融業者の遠藤により、かつて自分が<br>
                保証人になっていた借金を押しつけられる。<br>
                遠藤に誘われるままカイジは負債者に借金一括返済の<br>
                チャンスを与えるというギャンブル船「エスポワール」に<br>
                乗り込む。そこで行われるのはカード12枚を<br>
                使った「限定ジャンケン」。うまく勝てば借金は帳消しだが、<br>
                負ければ命の保証は無いというものだった……。
            </div>
        </div>
