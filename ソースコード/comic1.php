...
<div class="container">
    <div id="parent">
        ...
        <div id="child2">
            <div class="comicimg"><img src="img/ワンピース.png" width="260" height="386"></div><br>
            <?php
             $pdo = new PDO('mysql:host=mysql147.phy.lolipop.lan;
                dbname=LAA1291127-rainbows;charset=utf8',
        'LAA1291127',
        '1234123');
             foreach($pdo->query('SELECT item_code, item_name, price FROM m_items WHERE item_code = 1') as $row){
