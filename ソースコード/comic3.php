...
<div class="container">
    <div id="parent">
        ...
        <div id="child2">
            <div class="comicimg"><img src="img/ジョジョ.png" width="260" height="386"></div><br>
            <?php
            $pdo = new PDO('mysql:host=mysql147.phy.lolipop.lan;
                dbname=LAA1291127-rainbows;charset=utf8',
                'LAA1291127',
                '1234123');
            foreach($pdo->query('SELECT item_code, item_name, price FROM m_items WHERE item_code = 3') as $row){
            ...
            <div class="comic_summary">
                19世紀末、英国貴族、ジョースター卿は恩人の息子、<br>
                ディオを養子にする。だがディオは本当の息子、<br>
                ジョナサン(ジョジョ)を退け、財産の横取りを計画。<br>
                謎の石仮面でジョジョを殺そうとする。
            </div>
        </div>
    </div>
