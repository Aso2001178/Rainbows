...
<div class="container">
    <div id="parent">
        ...
        <div id="child2">
            <div class="comicimg"><img src="img/ドラゴンボール.png" width="260" height="386"></div><br>
            <?php
            $pdo = new PDO('mysql:host=mysql147.phy.lolipop.lan;
                dbname=LAA1291127-rainbows;charset=utf8',
                'LAA1291127',
                '1234123');
            foreach($pdo->query('SELECT item_code, item_name, price FROM m_items WHERE item_code = 5') as $row){
            ...
            <div class="comic_summary">
                山奥に住む怪力で、メチャクチャ元気な孫悟空。<br>
                ある日悟空は、七つ揃うとどんな願いも叶うという、<br>
                ドラゴンボールを探すブルマに出会う。彼女とともに、<br>
                悟空もハラハラドキドキの旅へ出発する！
            </div>
        </div>
    </div>
