...
<div class="container">
    <div id="parent">
        ...
        <div id="child2">
            <div class="comicimg"><img src="img/ヒロアカ.png" width="260" height="386"></div><br>
            <?php
            $pdo = new PDO('mysql:host=mysql147.phy.lolipop.lan;
                dbname=LAA1291127-rainbows;charset=utf8',
                'LAA1291127',
                '1234123');
            foreach($pdo->query('SELECT item_code, item_name, price FROM m_items WHERE item_code = 14') as $row){
            ...
            <div class="comic_summary">
                多くの人間が“個性”という力を持つ。<br>
                だが、それは必ずしも正義の為の力ではない。<br>
                しかし、避けられぬ悪が存在する様に、<br>
                そこには必ず我らヒーローがいる！<br>
                ん？　私が誰かって？　HA―HA―HA―HA―HA！<br>
                さぁ、始まるぞ少年！　君だけの夢に突き進め！　<br>
                “Plus Ultra”!!
            </div>
