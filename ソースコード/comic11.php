    ...
    <div id="parent">
        <div id="child1">
            ...
            <div class="btn">
                ...
                <a href="customer-list" class="button">登録情報</a><br>
        ...
        <div id="child2">
            <div class="comicimg"><img src="img/転生したらスライムだった件.png" width="260" height="386"></div><br>
            <?php
            $pdo = new PDO('mysql:host=mysql147.phy.lolipop.lan;
                dbname=LAA1291127-rainbows;charset=utf8',
                'LAA1291127',
                '1234123');
            foreach($pdo->query('SELECT item_code, item_name, price FROM m_items WHERE item_code = 11') as $row){
            ...
            <div class="comic_summary">
                WEBで記録的なPVを集めた異世界転生モノの名作を、<br>
                原作者完全監修でコミカライズ！<br>
                巻末には原作者書き下ろしの短編小説を収録した、<br>
                ファン必携の単行本いよいよ発売！
            </div>
        </div>
