...
<div class="container">
    <div id="parent">
        ...
        <div id="child2">
            <div class="comicimg"><img src="img/鬼滅の刃.png" width="260" height="386"></div><br>
            <?php
            $pdo = new PDO('mysql:host=mysql147.phy.lolipop.lan;
                dbname=LAA1291127-rainbows;charset=utf8',
                'LAA1291127',
                '1234123');
            foreach($pdo->query('SELECT item_code, item_name, price FROM m_items WHERE item_code = 7') as $row){
            ...
            <div class="comic_summary">
                時は大正時代。<br>
                炭を売る心優しき少年・炭治郎の日常は、<br>
                家族を鬼に皆殺しにされたことで一変する。<br>
                唯一生き残ったものの、鬼に変貌した妹・禰豆子を<br>
                元に戻すため、また家族を殺した鬼を討つため、<br>
                炭治郎と禰豆子は旅立つ!!<br>
                血風剣戟冒険譚、開幕!!
            </div>
        </div>
