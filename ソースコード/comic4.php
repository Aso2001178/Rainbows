...
<div class="container">
    <div id="parent">
        ...
        <div id="child2">
            <div class="comicimg"><img src="img/ナルト.png" width="260" height="386"></div><br>
            <?php
            $pdo = new PDO('mysql:host=mysql147.phy.lolipop.lan;
                dbname=LAA1291127-rainbows;charset=utf8',
                'LAA1291127',
                '1234123');
            foreach($pdo->query('SELECT item_code, item_name, price FROM m_items WHERE item_code = 4') as $row){
            ...
            <div class="comic_summary">
                ここは木ノ葉隠れの里。<br>
                忍術学校の問題児、ナルトは今日もイタズラ三昧!!<br>
                そんなナルトのでっかい夢は歴代の勇者、<br>
                火影の名を受けついで、先代を越える忍者になることだ。<br>
                だがナルトには出生の秘密が…!?
            </div>
        </div>
    </div>
