...
<div class="container">
    <div id="parent">
        ...
        <div id="child2">
            <div class="comicimg"><img src="img/キングダム.png" width="260" height="386"></div><br>
            <?php
            $pdo = new PDO('mysql:host=mysql147.phy.lolipop.lan;
                dbname=LAA1291127-rainbows;charset=utf8',
                'LAA1291127',
                '1234123');
            foreach($pdo->query('SELECT item_code, item_name, price FROM m_items WHERE item_code = 9') as $row){
            ...
            <div class="comic_summary">
                時は紀元前――。いまだ一度も統一されたことのない<br>
                中国大陸は、500年の大戦争時代。<br>
                苛烈な戦乱の世に生きる少年・信は、<br>
                自らの腕で天下に名を成すことを目指す!!<br>
