...
<div class="container">
    <div id="parent">
        ...
        <div id="child2">
            <div class="comicimg"><img src="img/からかい上手の高木さん.png" width="260" height="386"></div><br>
            <?php
            $pdo = new PDO('mysql:host=mysql147.phy.lolipop.lan;
                dbname=LAA1291127-rainbows;charset=utf8',
                'LAA1291127',
                '1234123');
            foreach($pdo->query('SELECT item_code, item_name, price FROM m_items WHERE item_code = 12') as $row){
            ...
            <div class="comic_summary">
                いっつもオレをからかってくる隣の席の高木さん。<br>
                だけど見ていろ、今日こそは必ず高木さんを<br>
                からかって恥ずかしがらせてやる！！
            </div>
        </div>
